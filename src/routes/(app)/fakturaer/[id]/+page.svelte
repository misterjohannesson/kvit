  ...
  <div class="layout-8-4">
    <div class="panel">
      ...
      <div class="panel__body">
        <dl class="facts">
          <div><dt>Kunde</dt><dd>{inv.customer.name}<span class="cell-sub">{inv.customer.address}, {inv.customer.zip} {inv.customer.city}{#if inv.customer.cvr} · CVR <span class="mono">{formatCvr(inv.customer.cvr)}</span>{/if}</span></dd></div>
