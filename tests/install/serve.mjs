...
http
  .createServer((req, res) => {
    ...
    const types = { '.html': 'text/html; charset=utf-8', '.css': 'text/css', '.svg': 'image/svg+xml', '.png': 'image/png', '.js': 'text/javascript', '.mjs': 'text/javascript', '.sh': 'text/plain', '.ps1': 'text/plain', '.md': 'text/markdown' };
